...
resource "azurerm_network_security_rule" "tfproject-nsgrules" {
  for_each = {for rule in var.var.nsgrules:rule.id=>rule} # this will take "id" parameter in the nsgrule module call as the "key" and rest of the parameters as "values"
